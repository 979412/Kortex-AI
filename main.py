        ...
        if is_image_request and use_vision_gen:
            with st.spinner(f"🎨 Kortex Vision Realistik Detalları Oxuyur..."):
                ...
                if not clean_prompt:
                    ...
                    clean_prompt += ", highly detailed photorealistic car photography, natural daylight, professional lighting, 8k resolution, highly detailed, no neon, no text"
                ...
                response_text = f"Buyur, istədiyin təsvir hazırdır! Kortex qlobal bazadan istifadə etdi. (4K Fotorealistik Mühərrik)"
