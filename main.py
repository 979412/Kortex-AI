...
if st.session_state.selected_tier == "Basic":
    ...
    # BURA DÜZƏLDİ! Artıq "qısa cavab ver" yazılmayıb.
    tier_personality = " Sən çox səmimi, mehriban, köməksevər və insan kimi danışan bir asistansan. Qətiyyən tək kəlməlik robotik cavablar vermə! İstifadəçi ilə dost kimi, təbii cümlələrlə söhbət et."
...
# ==========================================================
# İSTİFADƏÇİNİN YERİNİ BURADAN DA SİLDİM Kİ, AĞLINA BELƏ GƏLMƏSİN!
                ...
                with st.spinner(f"Kortex AI ({active_llm_model}) analiz edir..."):
                    ...
                    try:
                        chat_completion = client.chat.completions.create(
                            messages=messages,
                            model=active_llm_model, 
                            temperature=0.7, # Söhbət daha təbii olsun deyə artırdım
