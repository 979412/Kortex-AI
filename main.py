            ...
            with st.spinner(f"Kortex AI ({active_llm_model}) düşünür..."):
                ...
                try:
                    if client:
                        ...
                        response = "⚠️ Sistem Xətası: Arxa planda AI motoru qoşulmayıb və ya şifrə etibarsızdır. Zəhmət olmasa admin 'Streamlit Secrets' ayarlarını etsin."
