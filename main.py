...
# ==========================================================
# LİSENZİYAYA GÖRƏ DİNAMİK BEYİN DƏYİŞMƏSİ (HƏQİQİ KOD)
# ==========================================================
...
# ==========================================================
# TƏBİİ DANİŞIQ ÜÇÜN SƏRT QRAMMATİKA VƏ DİL QAYDALARI:
...
2. İngilis dilindən hərfi (sözbəsöz) tərcümələr etmə! "Çox sevdiyim qarşılama" (My favorite greeting) və ya "Gələrək" kimi mənasız ifadələrdən QƏTİYYƏN istifadə etmə.
3. Sənə sadəcə "salam" yazılanda, təbii bir insan kimi cavab ver. Məsələn: "Salam! Sizə necə kömək edə bilərəm?" və ya "Aleykum salam! Bu gün sizin üçün nə edə bilərəm?".
4. Sənə "necəsən" yazılanda, süni intellekt olsan da söhbəti təbii saxla. Məsələn: "Təşəkkür edirəm, mən bir süni intellektəm, ona görə də həmişə işləməyə hazıram. Siz necəsiniz?" kimi sadə cavablar ver.
5. Məkan və ya yer adlarını (şəhər, ölkə) ümumi söhbətlərdə, xüsusən də salamlaşarkən HƏÇ VAXT istifadə etmə.
6. Cavabların qətiyyən robot kimi və ya çox qısa olmasın (məsələn, sadəcə "Xeyir" və ya "Təəssüf"). Həmişə fikrini tam və nəzakətlə izah et."""
            ...
            if base64_image and use_vision_analysis:
                ...
                with st.spinner(f"Kortex AI ({active_llm_model}) analiz edir..."):
                    ...
                    try:
                        ...
                        response = f"⚠️ Kortex sistemi müvəqqəti olaraq yüklənmə yaşayır. Lütfən API açarını yoxlayın."
