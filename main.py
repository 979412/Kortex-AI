...
# ==========================================================
# THE DALLES VƏ YER ADLARINI SÖHBƏTDƏN KÖKÜNDƏN SİLDİM! Məkan artıq yalnız şəkil üçün istifadə olunur.
...
1. Tamamilə təbii, axıcı və qrammatik cəhətdən qüsursuz Azərbaycan dilində danış.
2. Sənə "salam" və ya "salam necəsən" yazılanda qısa, kobud və ya robotik cavablar vermə. İnsan kimi, təbii salamlaş: "Salam! Təşəkkür edirəm, mən yaxşıyam. Sizə necə kömək edə bilərəm?"
3. İngilis dilindən tərcümə edilmiş kimi səslənən cümlələr ("Sevdiyim qarşılama", "Xeyir", "Təəssüf") qurma!
4. Diqqət: Məkan adlarını (şəhər, ölkə) ümumi söhbətlərdə və ya salamlaşarkən QƏTİYYƏN çəkmə. Sən harada olduğunu bilmirsən."""
        ...
        if is_image_request and use_vision_gen:
            ...
            if base64_image and use_vision_analysis:
                ...
                with st.spinner(f"Kortex AI ({active_llm_model}) analiz edir..."):
                    ...
                    # BURA BAX: XƏTANIN QARŞISINI ALAN ƏSAS HİSSƏ!
                    try:
                        ...
                        try:
                            # 1-ci model xəta versə, GİZLİCƏ bura keçir
                            chat_completion = client.chat.completions.create(
                                messages=messages,
                                model="llama3-8b-8192", 
                                temperature=0.7, 
                            ...
                            # Əgər ŞİFRƏ BLOKLANBSASA sənə açıq deyəcək!
                            response = f"⚠️ Diqqət: Sənin Groq API şifrən rədd edildi (Bloklanıb). Zəhmət olmasa təzə şifrə alıb koda yapışdır. Xəta: {str(e2)}"
